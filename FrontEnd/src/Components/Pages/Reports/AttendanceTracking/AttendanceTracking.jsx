          ...
          <div className='vorview-daily-attendance'>
            ...
            <div className='daily-attendance'>
              ...
              <div className='daily-attendance daily-attendance-border'>
                <p>{t("Breakdown")}</p>
                <div>
                    <p>{t("Sick")} <span>20 (44%)</span></p>
                    <p>{t("Annual")} <span>15 (33%)</span></p>
                    <p>{t("Unpaid")} <span>10 (23%)</span></p>
            ...
            <div className='daily-attendance'>
              ...
              <div className='daily-attendance daily-attendance-border'>
                <p>{t("Departments")}</p>
                <div>
                    <p>{t("Engineering")} <span>120 {t("hours")}</span></p>
                    <p>{t("Product")} <span>75 {t("hours")}</span></p>
